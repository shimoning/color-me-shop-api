...
class DateTimeTest extends TestCase
{
    ...
    public static function invalidStringProvider(): array
    {
        return [
            ...
            // 正規表現の $ は D 修飾子がないと末尾の改行にマッチしてしまう
            '末尾に改行' => ["2024-01-01\n"],
            '日時の末尾に改行' => ["2024-01-01 12:34:56\n"],
            // 区切りは半角スペースのみ。\s だと以下も通ってしまう
            '区切りが改行' => ["2024-01-01\n12:34:56"],
            '区切りがタブ' => ["2024-01-01\t12:34:56"],
            '区切りが復帰' => ["2024-01-01\r12:34:56"],
            '区切りが垂直タブ' => ["2024-01-01\v12:34:56"],
            '区切りが全角スペース' => ['2024-01-01　12:34:56'],
            '区切りがスペース2つ' => ['2024-01-01  12:34:56'],
        ];
    }
